#> kstories:config/change_function

# Playsound
playsound block.note_block.bit master @s ~ ~ ~ 1 2

# Change Duration
$data modify entity @e[type=marker,sort=nearest,limit=1,distance=..2,tag=k.StoryMarker] data.Story[$(Line)].Function set value "$(Function)"
